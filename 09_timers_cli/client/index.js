...
const handleLogout = async () => {
  ...
  try {
    await axios.post(`${SERVER_URL}/logout`, {}, { headers: { Authorization: sessionId } });
    deleteSessionId();
...
const handleStart = async () => {
  ...
  try {
    await axios.post(`${SERVER_URL}/start`, {}, { headers: { Authorization: sessionId } });
...
const handleStop = async () => {
  ...
  try {
    await axios.post(`${SERVER_URL}/stop`, {}, { headers: { Authorization: sessionId } });
...
const handleStatus = async () => {
  ...
  try {
    ...
    console.log("⏳ Timer status:", res.data);
  } catch (err) {
    console.error("❌ Request failed:", err.message);
  }
};
